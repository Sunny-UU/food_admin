<template>
  <div class="app-container">
    <div class="filter-container" style="text-align: left">
      <el-input v-model="listQuery.title" placeholder="标题查询" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
      ...
      <el-select v-model="listQuery.sort" placeholder="日期" style="width: 140px" class="filter-item" @change="handleFilter">
...
<!--        </template>-->
      ...
      <el-table-column label="口味" align="center" width="80px">
<!--        <template slot-scope="{row}">-->
<!--          <svg-icon v-for="n in + row.importance" :key="n" icon-class="star" class="meta-item__icon" />-->
<!--        </template>-->
      </el-table-column>
      <el-table-column label="难易度" align="center" width="80px">
<!--        <template slot-scope="{row}">-->
<!--          <svg-icon v-for="n in + row.importance" :key="n" icon-class="star" class="meta-item__icon" />-->
<!--        </template>-->
      </el-table-column>
...
<!--        </template>-->
      ...
      <el-table-column label="阅读量" align="center" width="95px">
<!--        <template slot-scope="{row}">-->
<!--          <span v-if="row.pageviews" class="link-type" @click="handleFetchPv(row.pageviews)">{{ row.pageviews }}</span>-->
<!--          <span v-else>0</span>-->
<!--        </template>-->
      </el-table-column>
      <el-table-column v-if="showReviewer" label="评论量" align="center" width="110px">
<!--        <template slot-scope="{row}">-->
